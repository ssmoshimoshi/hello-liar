    ...
    <div className="max-w-4xl mx-auto px-6 md:px-12">
      ...
      <header className="py-20 md:py-32 border-b" style={{ borderColor: 'var(--gray-200)' }}>
        <div className="flex justify-between items-center mb-6">
          ...
          {/* Minimalist Filter Dropdown */}
          <details className="relative group">
            <summary 
              className="list-none cursor-pointer flex items-center gap-2 text-[11px] font-sans uppercase tracking-[0.2em] transition-colors hover:text-foreground"
              style={{ color: 'var(--gray-400)' }}
            >
        ...
        <h1 className="text-[2.5rem] leading-[1.1] md:text-6xl lg:text-7xl font-serif font-black tracking-tight max-w-3xl break-words hyphens-auto">
          {locale === 'en' 
      ...
      <section className="py-16 md:py-24">
        {/* Sort Tabs have been moved to the header filter icon */}
            ...
            return (
              ...
              >
                <Link href={`/${locale}/read/${lie.id}`} className="block">
                  ...
                  {/* Story text */}
                  <p className="text-4xl md:text-5xl lg:text-6xl leading-tight md:leading-tight font-[var(--font-discipline)] transition-transform duration-700 group-hover:translate-x-2 break-words break-all text-[var(--foreground)]">
                    &ldquo;{content}&rdquo;
                  </p>

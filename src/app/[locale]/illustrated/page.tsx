...
export default async function Gallery({
  ...
  return (
    <div className="w-full h-full overflow-y-auto hide-scrollbar select-none" style={{ WebkitOverflowScrolling: 'touch' }}>
      <div className="max-w-7xl mx-auto px-6 md:px-12 pt-16 pb-40 md:pt-24 md:pb-48">
                  ...
                  <Link href={`/${locale}/read/${lie.id}`} className="block relative w-full h-full">
                    ...
                    {lie.illustration_url ? (
                      <img 
                        ...
                        className="w-full h-auto object-cover grayscale contrast-125 transition-all duration-500 group-hover:grayscale-0 group-hover:contrast-100"
                      />
                    ) : (
                    ...
                    <div className="absolute inset-0 bg-black/90 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-between p-8 text-white">
                      <p 
